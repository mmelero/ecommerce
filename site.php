<?php
    ...
    $app->post("/checkout", function(){
        ...
        $cart = Cart::getFromSession();
        //-- não esta levando o valor total $cart->getCalculateTotal()
    ...
    $app->post("/register", function (){
        ...
        if(User::checkLoginExist($_POST['email']) === true ){
            User::setErrorRegister("Este endereço de e-mail, já está sendo utlizado por outro usuário.");
            header("Location: /login");
            exit();
        }
    ...
    // SEUS DADOS
            $dadosboleto["identificacao"] = "L&M SysInfo";
            $dadosboleto["cpf_cnpj"] = "24.700.731/0001-08";
            $dadosboleto["endereco"] = "Rua Ademar Saraiva Leão, 234 - Alvarenga, 09853-120";
            $dadosboleto["cidade_uf"] = "Guarulhos - SP";
            $dadosboleto["cedente"] = "L&M SysInfo Sistemas de Informação - ME";
